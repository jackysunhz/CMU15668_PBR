...
template <int nSpectrumSamples>//number of samples the spectrum has
class CoefficientSpectrum {
  public:
    // CoefficientSpectrum Public Methods
    CoefficientSpectrum(float v = 0.f) 
    {
        //initialize spectrum value to v across all wavelengths
...
class SampledSpectrum : public CoefficientSpectrum<nSpectralSamples> {
  public:
    ...
    Color3f SingleToRGB(float lambdaSample) const {
        // cout << "lambdaSample " << lambdaSample << endl;
        // Color3f tmp;
        // ToRGB(tmp);
        // cout << "origRGB " << tmp << endl;
        float sPower = c[(int)(nSpectralSamples * lambdaSample)];
        //cout << "sPower: " << sPower << endl;
        float xyz[3];
        xyz[0] = sPower * X.c[(int)(nSpectralSamples * lambdaSample)] * nSpectralSamples;
        xyz[0] = sPower * Y.c[(int)(nSpectralSamples * lambdaSample)] * nSpectralSamples;
        xyz[0] = sPower * Z.c[(int)(nSpectralSamples * lambdaSample)] * nSpectralSamples;
        //cout << "xyz before scaling " << xyz[0] << " " << xyz[1] << " " << xyz[2] << endl;
        ...
        xyz[1] *= scale;
        xyz[2] *= scale;
        //cout << "xyz after scaling " << xyz[0] << " " << xyz[1] << " " << xyz[2] << endl;

        float rgb[3];
        XYZToRGB(xyz, rgb);
        //cout << "rgb" << rgb[0] << " " << rgb[1] << " " << rgb[2] << endl << endl;
    ...
    static SampledSpectrum FromRGB(const Color3f rgb, SpectrumType type = SpectrumType::Illuminant);
...
class RGBSpectrum : public CoefficientSpectrum<3> {
  ...
  public:
    ...
    static RGBSpectrum FromRGB(Color3f rgb,
                               SpectrumType type = SpectrumType::Reflectance) {
        RGBSpectrum s;
        s.c[0] = rgb[0];
        s.c[1] = rgb[1];
