...
shared_ptr<Integrator> parseIntegrator(const json & j)
{
    ...
    else if (type == "path_tracer_sss")
        return make_shared<PathTracerMIS>(j);
    else if (type == "path_tracer_spectral")
        return make_shared<PathTracerSpectral>(j);
...
shared_ptr<Material> parseMaterial(const json & j)
{
    ...
    else if (type == "spectral dielectric")
        return make_shared<SpectralDielectric>(j);
	else
